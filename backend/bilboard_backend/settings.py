"""
Django settings for bilboard_backend project.
...
ROOT_URLCONF = 'bilboard_backend.urls'
...
ASGI_APPLICATION = 'bilboard_backend.asgi.application'
WSGI_APPLICATION = 'bilboard_backend.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 16,  # of items per page
}
